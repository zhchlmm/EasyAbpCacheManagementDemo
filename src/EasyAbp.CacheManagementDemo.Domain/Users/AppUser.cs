...
namespace EasyAbp.CacheManagementDemo.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update CacheManagementDemoDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CacheManagementDemoEfCoreEntityExtensionMappings to extend the IdentityUser entity
